...
import {FaTimes, FaCheck, FaDashcube} from "react-icons/fa"
    ...
    <div className="table-auto overflow-x-scroll md:mx-auto p-3 scrollbar scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500 ">
      {
        ...
        ?(<>
          ...
          {showMore && (<button 
          onClick={handleShowMore} className="w-full text-teal-500 self-center text-sm py-7">Show More</button>)}
          </>)
        :(<p>no comments</p>)
      }
      <Modal
            ...
            <Modal.Header/>
                <Modal.Body>
                    <div className="text-center">
                        ...
                        <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Confirm to delete?</h3>
